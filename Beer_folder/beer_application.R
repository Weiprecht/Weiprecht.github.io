...
beerPath <- "D:/Website/SimpleWebsite/Weiprecht.github.io/beer_updated.csv"
beer_data <- read.csv(beerPath, header = TRUE)

# URL to the raw content of the CSV file on GitHub
# github_url <- "https://raw.githubusercontent.com/Weiprecht/Weiprecht.github.io/main/beer_updated.csv"
