...
github_url <- "https://raw.githubusercontent.com/Weiprecht/Weiprecht.github.io/main/Beer_code_data/Beers.csv"

# Read the CSV file from the GitHub repository
#Beer_Data <- read_csv(github_url)

#Breweries_Data
github_url2 <- "https://raw.githubusercontent.com/Weiprecht/Weiprecht.github.io/main/Beer_code_data/Breweries.csv"
#Breweries_Data = read.csv(github_url2)

Beer_Data <- read_csv(github_url, locale = locale(encoding = "UTF-8"))
Breweries_Data <- read_csv(github_url2, locale = locale(encoding = "UTF-8"))
