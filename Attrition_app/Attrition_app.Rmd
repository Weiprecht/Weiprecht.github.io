...
attrition_Data2 <- attrition_Data
attrition_Data2$Attrition = factor(attrition_Data2$Attrition, levels = c("Yes", "No"))
  ...
  sidebarLayout(
    sidebarPanel(
      selectInput("selected_variable", "Select Variable:",
                  choices = c("OverTime", "JobRole", "EmployeeSatisfaction"),
                  selected = "OverTime")
    ),
    mainPanel(
